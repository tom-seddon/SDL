...
SDL_DYNAPI_PROC(int,SDL_RenderGeometry,(SDL_Renderer *a, SDL_Texture *b, const SDL_Vertex *c, Uint32 d, const Uint16 *e, Uint32 f, const SDL_Vector2f *g),(a,b,c,d,e,f,g),return)
