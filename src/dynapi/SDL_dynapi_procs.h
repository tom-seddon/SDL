...
SDL_DYNAPI_PROC(int,SDL_RenderGeometry,(SDL_Renderer *a, SDL_Texture *b, SDL_Vertex *c, Uint16 d, const Uint16 *e, int f, const SDL_Vector2f *g),(a,b,c,d,e,f,g),return)
