...
/**
 *  \brief Render a triangle list, optionally indexed, optionally using a texture
 *
 ...
 *  \param indices (optional) An array of integers indices into the vertices array
 *  \param num_indices  Number of elements in the indices array; ignored if no indices
 *  \param translation (optional) A translation vector that will be applied to the vertices prior to rendering
 *
 *  \return 0 on success, or -1 if the operation is not supported
 */
extern DECLSPEC int SDLCALL SDL_RenderGeometry(SDL_Renderer * renderer, SDL_Texture *texture, const SDL_Vertex *vertices, Uint32 num_vertices, const Uint16* indices, Uint32 num_indices, const SDL_Vector2f *translation);
